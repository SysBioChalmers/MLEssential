...
def get_sequence(genes) :
    ...
    with open("../Data/geneseq/P_pastoris.cds.fasta", "r") as handleGene :
        geneSeq = dict()
        ...
        print(len(geneSeq))
        print(geneSeq["PAS_chr4_0819"])

    # get the protein sequence according to protein sequence id
    with open("../Data/proteinseq/P_pastoris.peptide.fasta.faa", "r") as handleProtein :
        proteinSeq = dict()
        ...
        print(proteinSeq["PAS_chr4_0819"])
...
def main() :
    ...
    genes = read_xls("P. pastoris.xlsx")
    geneAll = get_sequence(genes)

    # write geneAll list into processed data folder
    with open("../Data/processed_data/P_pastoris.json", "w") as outfile :

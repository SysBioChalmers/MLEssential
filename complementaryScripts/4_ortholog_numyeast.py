...
def getOrthologSpecies() :
    file = os.path.join("/Users/leyu/Documents/coding/MLEssential/Data/processed_data", "ortholog_occurence_num_all.tsv")
...
def getId(organism) :
    with open("../processed_data/%s_include_id.json" % organism) as f :
        geneAll = json.load(f)
    ...
    for gene in geneAll :
        try :
            ...
            print(gene)
    print("The number of ortholog mapping with protein id for %s: %d" % (organism,len(geneAll)))
...
def main() :
    ...
    for organism in organisms :
        ...
        with open("../processed_data/%s_include_ortholog.json" % organism, "w") as outfile :
...
# The number of ortholog mapping with protein id: 6188
# The number of ortholog mapping with protein id: 4903
# The number of ortholog mapping with protein id: 5380
# The number of ortholog mapping with protein id: 5019
# The number of ortholog mapping with protein id: 5442

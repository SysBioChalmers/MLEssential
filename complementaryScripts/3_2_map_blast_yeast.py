...
def create_blast_command(strain) :
    ...
    fwd_out = os.path.join("../recip_target3/", "%s_fwd.tab" % strain)
    rev_out = os.path.join("../recip_target3/", "%s_rev.tab" % strain)
...
def plot_rbbh(fwd_results, rev_results, strain) : # reciprocal blast best hits
    ...
    plt.savefig("../recip_target3/%s_rbbh.png" % strain, dpi=400)
...
# The number of protein complex data: 5311  5143
...
# The number of protein complex data: 5935  5949
